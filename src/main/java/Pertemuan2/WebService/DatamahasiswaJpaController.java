 ...
 */
package Pertemuan2.WebService;

import Pertemuan2.WebService.exceptions.NonexistentEntityException;
import Pertemuan2.WebService.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("Pertemuan.12_WebService_jar_0.0.1-SNAPSHOTPU");
